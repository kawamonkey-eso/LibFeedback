...
local amounts = {0,5000,50000, "https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=7CZ3LW6E66NAU"}
...
local function createShowFeedbackWindow()
end

local function createFeedbackWindow()


local function initializeFeedbackWindow(parentAddonNameSpace, parentAddonName, destination, windowName, mailButtonPosition)
	local feedbackWindow = WINDOW_MANAGER:CreateControlFromVirtual(owningWindow:GetName().."feedbackWindow", owningWindow, "FeedbackTemplate")
...
parentAddonNameSpace.initializeFeedbackWindow = initializeFeedbackWindow